...
all_tags.append(Tag('prankster', effect_text='-', weight=20, requires={'Aestival'}))
...
all_tags.append(Tag('cold logic', effect_text='-', overwritten_by={'logic'}, overwrites={'logic'}, requires={'Brumal'}))
...
all_tags.append(Tag('stubborn', '-', requires={'Aestival'}))
all_tags.append(Tag('capricious', '-', requires={'Aestival'}))
all_tags.append(Tag('patient', '-', requires={'Autumnal'}))
all_tags.append(Tag('generous', '-', requires={'Autumnal'}))
all_tags.append(Tag('prideful', '-', requires={'Brumal'}))
all_tags.append(Tag('careful', '-', requires={'Brumal'}))
all_tags.append(Tag('unwaveringly loyal', '-', requires={'Brumal'}))
all_tags.append(Tag('plays dead', '-'))
all_tags.append(Tag('howls at the moon', '-'))
all_tags.append(Tag('howls at the sun', '-', requires={'Aestival'}))
